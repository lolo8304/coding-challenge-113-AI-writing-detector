package ch.lolo.coding.challenge.ai.writer.detector.contracts.versioning.aggregate;
...
public class PremiumsAggregateTransformer {
    ...
    public void convertAggregateToPremium(ObjectNode json) {
        JsonNode premiums = json.get("premiums");
